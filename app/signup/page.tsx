...
const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
  ...
  if (name === "password") {
    ...
    setPasswordValidation({ isValid, errorMessage });
  }
};
  ...
  const handleNextStep = (e: React.FormEvent) => {
    ...
    if (step === 1 && !passwordValidation.isValid) {
    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="w-full max-w-md p-8 bg-white shadow-md rounded-lg text-center">
        ...
        {step === 1 && (
          ...
          <Button
  type="submit"
  className={`w-full py-2 text-white bg-black ${!passwordValidation.isValid || !formData.name || !formData.email || !formData.password ? "cursor-not-allowed" : ""} disabled:opacity-100 disabled:cursor-not-allowed`}
  disabled={!passwordValidation.isValid || !formData.name || !formData.email || !formData.password}
>
  Next
</Button>
